...
export const Definitions = {
  ...
  prompt_voice_start: keybind({ key: "ctrl+space", event: "press" }, "Start voice dictation"),
  prompt_voice_stop: keybind({ key: "ctrl+space", event: "release" }, "Stop voice dictation"),
