export const dict = {
  ...
  "provider.connect.accountName.placeholder": "Work, personal, or team name",
  "provider.connect.accountName.description": "Use a name that will help you identify this account later.",
  ...
  "settings.providers.accounts.loading": "Loading saved accounts…",
  "settings.providers.accounts.loadError": "Saved accounts could not be loaded. You can still manage other settings.",
  "settings.providers.account.add": "Add account",
  "settings.providers.account.active": "Active",
  "settings.providers.account.oauth": "OAuth",
  "settings.providers.account.managed": "Managed",
  "settings.providers.account.use": "Use account",
  "settings.providers.account.switching": "Switching…",
  "settings.providers.account.remove": "Remove account",
  "settings.providers.account.removing": "Removing…",
  "settings.providers.account.select.success": "Using {{account}}",
  "settings.providers.account.select.error": "Could not switch accounts",
  "settings.providers.account.remove.success": "Removed {{account}}",
  "settings.providers.account.remove.error": "Could not remove account",
